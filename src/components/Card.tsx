...
export function Card() {
  ...
  return (
    <div className="grid grid-cols-3 shadow-lg rounded-lg border border-gray-200 lg:max-w-xl p-4 gap-4 mb-10">
      ...
      <div className="col-span-1 w-full h-full bg-slate-600"></div>
      ...
      <div className="col-span-2">
        ...
        <Button title="Ver mais" variant='light' className="w-full mb-0 hover:bg-emerald-500 hover:text-white"/>
      </div>
